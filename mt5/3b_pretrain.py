...
gin.parse_config_file(
    '/raid/yiptmp/huggingface-models/mt5-3b-tf-ckpt/pretrain_operative_config.gin'
)
...
PRETRAINED_DIR = "/raid/yiptmp/huggingface-models/mt5-3b-tf-ckpt"
model = t5.models.MtfModel(
    tpu=None,
    model_dir=PRETRAINED_DIR,
    mesh_shape="model:4, batch:2",
...
model.train(mixture_or_task_name='all_bioT5', steps=1100001)
export_dir = os.path.join(
    '/raid/zyftest/project/Med0/mt5/pretrain_model', "mt5_3b_tf")
