...
gin.parse_config_file(
    '/raid/yiptmp/huggingface-models/mt5-small-tf-ckpt/pretrain_operative_config.gin'
)
...
PRETRAINED_DIR = "/raid/yiptmp/huggingface-models/mt5-small-tf-ckpt"
...
export_dir = os.path.join(
    '/raid/zyftest/project/SciFive/result_model', "mt5_small_tf")
